...
class VideoLibrary {
  ...
  VideoLibrary() {
    ...
    try {
      File file = //new File(this.getClass().getResource("/videos.txt").getFile()); <- Uncomment and delete line 23
          new File("C:\\Users\\Abdul Rahman\\IdeaProjects\\google-code-sample\\java\\target\\classes\\videos.txt");
